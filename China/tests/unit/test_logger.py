...
class TestSetupLogger:
    ...
    def test_setup_logger_default_params(self, temp_logs_dir, clean_loggers):
        ...
        with patch('src.utilities.logger.Path') as mock_path:
            ...
            mock_path.return_value.__truediv__.return_value = Path(temp_logs_dir) / "test.log"
    ...
    @pytest.mark.unit
    def test_setup_logger_prevents_duplicate_handlers(self, temp_logs_dir, clean_loggers):
